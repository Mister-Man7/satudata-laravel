...
<x-layout>
    ...
    <section class="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-10">
        <x-ui.card class="mt-6" badge="SATUDATA UNTIRTA" title="Cari Data Apa Hari Ini?"
            ...
            action="#" method="GET" placeholder="Cari data..." image="images/anim_4.svg" image-alt="Vector SatuData"
            button="Cari"></x-ui.card>
    </section>
    <section class="mx-auto max-w-7xl px-4 pb-10 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
            ...
            <x-ui.dashboard-card title="Jumlah Mahasiswa Untirta"
                description="Status mahasiswa, gender, dan persebaran fakultas." badge="Akademik" href="/akademik"
                icon-bg="bg-indigo-50" icon-color="text-indigo-600">
                <x-slot:icon>
            ...
            <x-ui.dashboard-card title="Inventaris Sarana dan Prasarana"
                description="Ringkasan aset kampus berdasarkan kategori pemanfaatan." badge="Aset" href="/asset"
                icon-bg="bg-emerald-50" icon-color="text-emerald-600">
                <x-slot:icon>
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
            ...
            <x-ui.dashboard-card title="Komposisi Pegawai" description="Data pegawai aktif per unit kerja dan jabatan."
                badge="Pegawai" href="/pegawai" icon-bg="bg-yellow-50" icon-color="text-yellow-600">
                <x-slot:icon>
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
            ...
            <x-ui.dashboard-card title="Kondisi Infrastruktur"
                description="Status infrastruktur kampus berdasarkan kategori pemanfaatan." badge="Infrastruktur"
                href="/infrastruktur" icon-bg="bg-emerald-50" icon-color="text-emerald-600">
                <x-slot:icon>
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
